...
public typealias TextShouldChange = (_ textField: UITextField, _ range: NSRange, _ replacementString: String) -> Bool


@available(iOS 13.0, *)
public struct CustomFormatTextField: UIViewRepresentable {
    ...
    private var interceptor: TextFieldInterceptor?
    ...
    public init(unformattedText: Binding<String>,
                ...
                interceptor: TextFieldInterceptor? = nil) {
        self._unformattedText = unformattedText
        self.placeholder = placeholder
    ...
    public func makeCoordinator() -> Coordinator {
        ...
        coordinator.textFieldInterceptor = interceptor
        coordinator.maxLength = maxLength
        return coordinator
    }
    ...
    public class Coordinator: NSObject, UITextFieldDelegate {
        ...
        public var textFieldInterceptor: TextFieldInterceptor?
        ...
        public func textField(_ textField: UITextField, shouldChangeCharactersIn range: NSRange, replacementString string: String) -> Bool {
            ...
            if (textFieldInterceptor?.intercept(textField, range, string) ?? false) {
                return false
            }
